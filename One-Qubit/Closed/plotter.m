...
load('CRAB_1Q_Closed1.mat')
Z1 = self.infidelity ;
load('CRAB_1Q_Closed2.mat')
Z2 = self.infidelity ;
load('CRAB_1Q_Closed3.mat')
Z3 = self.infidelity ;
load('CRAB_1Q_Closed4.mat')
Z4 = self.infidelity ;
load('CRAB_1Q_Closed5.mat')
Z5 = self.infidelity ;
...
iter = 1:1000;
figure();
semilogy(0:length(Z1)-1,Z1,'r', 'LineWidth', lw);
hold on
semilogy(0:length(Z2)-1,Z2,'r', 'LineWidth', lw);
hold on
semilogy(0:length(Z3)-1,Z3,'r', 'LineWidth', lw);
hold on
semilogy(0:length(Z4)-1,Z4,'r', 'LineWidth', lw);
hold on
semilogy(0:length(Z5)-1,Z5,'r', 'LineWidth', lw);
hold on
