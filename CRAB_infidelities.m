...
% iter = 1:5001;
figure();
semilogy(iter1,Z1,'b', 'LineWidth', lw,'Color','k');
hold on
semilogy(iter2,Z2,'b', 'LineWidth', lw,'Color','k');
hold on
semilogy(iter3,Z3,'b', 'LineWidth', lw,'Color','k');
hold on
semilogy(iter4,Z4, 'b', 'LineWidth', lw,'Color','k');
hold on
semilogy(iter5,Z5, 'b', 'LineWidth', lw,'Color','k');
hold on
semilogy(iter6, Z6,'b', 'LineWidth', lw,'Color','k');
% title('(a)')
...
print('Infidelities-CRAB','-dpng','-r900');
print('Infdelities-CRAB','-depsc2','-r900');
